...
// Return all animals
$app -> get('/animals', function (Request $request, Response $response, array $args) {
...
$app -> get('/animals/{animal_ID}', function (Request $request, Response $response, array $args) {
    $id = $args['animal_ID'];
    $animal = new Animal();
    $_a = $animal->find($id);
...
$app -> get('/customers/{customer_ID}', function (Request $request, Response $response, array $args) {
    $id = $args['customer_ID'];
...
$app -> get('/employees/{employee_ID}', function (Request $request, Response $response, array $args) {
    $id = $args['employee_ID'];
...
$app -> get('/positions', function (Request $request, Response $response, array $args) {
...
$app -> get('/positions/{position_ID}', function (Request $request, Response $response, array $args) {
    $id = $args['position_ID'];
...
$app -> get('/food/{animalFood_ID}', function (Request $request, Response $response, array $args) {
