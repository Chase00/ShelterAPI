var oldHash = '';
var baseUrl_API = "http://localhost:8080/I425/Shelter/api"; // you need to fill this variable with your own api url
...
$(function () {
    ...
    window.addEventListener('hashchange', function (event) {
        ...
        if ($("a[href='#" + hash + "'").hasClass('disabled')) {
            showAnimal('Signin Error', 'Access is not permitted. Please <a href="index.php#signin">sign in</a> to explore the site.');
            return;
        }
...
function home() {
    ...
    updateMain('Home', 'Welcome to Animal Shelter Application', _html);
}
