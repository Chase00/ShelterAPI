...
function showAllAnimals() {
	console.log('Show all animals for employee.');
}
...
function displayAllAnimals(Animals, subheading=null) {
    console.log("display all animals for the editing purpose")
    ...
    for (let a in Animals) {
        ...
        _html += `<div class='content-row'>
            ...
            <div class='post-body' id='post-edit-body-${animal.id}'>${animal.body}</div> 
            <div class='post-image' id='post-edit-image_url-${animal.id}'>${animal.animal_name}</div>
            <div class='post-create' id='post-edit-created_at-${animal.id}'>${animal.animal_breed}</div> 
            <div class='post-update' id='post-edit-updated_at-${animal.id}'>${animal.animal_cost}</div>`;

            _html += `<div class='list-edit'><button id='btn-post-edit-${animal.id}' onclick=editPost('${animal.id}') class='btn-light'> Edit </button></div>
            <div class='list-update'><button id='btn-post-update-${animal.id}' onclick=updatePost('${animal.id}') class='btn-light btn-update' style='display:none'> Update </button></div>
            <div class='list-delete'><button id='btn-post-delete-${animal.id}' onclick=deletePost('${animal.id}') class='btn-light'>Delete</button></div>
            <div class='list-cancel'><button id='btn-post-cancel-${animal.id}' onclick=cancelUpdatePost('${animal.id}') class='btn-light btn-cancel' style='display:none'>Cancel</button></div>`
